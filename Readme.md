...
Este repositório contém a resolução dos exercícios referentes à Lista de Exercícios Opcional do Programa +praTi & Codifica.
...
```bash
git clone https://github.com/RodrigoBurgarelli/Lista-Opcional-maisPrati.git
...
23. Criar e imprimir a matriz identidade MI[1..7,1..7] em que todos os elementos dadiagonal principal são iguais a 1 e os demais são nulos.
